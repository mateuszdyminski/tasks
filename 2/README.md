...
Let's assume that some junior dev tries to add Pull Request to our code base. Please check this PR and give some comments in a way that junior dev will learn a lot from your knowledge
